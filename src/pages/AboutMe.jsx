  ...
  return (
    <>
      ...
      <p>
        ...
        general, which many of my hobbies/interests are centered around. My main
      ...
      <p>
        ...
        recursive backtracking, and dynamic programming. We explored how exactly
        each of these algorithms worked, as well as the efficiency of each one,
        using it as a metric to compare them to one another.
      </p>
      ...
      <p>
        ...
        projects with classes, and objects. I was able to understand fundamental
        concepts, such as methods, inheritance, polymorphism, and generic
        classes. Because of this course, one of my most comfortable programming
        languages is Java.
      </p>
